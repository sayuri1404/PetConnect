...
-- 3) Relaciones N:M (CSV: vacuna_enfermedad, vacuna_administracion, vacuna_tipoVacuna)
...
-- vacuna_administracion.csv  (OJO: columna viene como Asministracionid_administracionAd)
